...
export default function ModalInsert({name, setName, pos, setPos, imagen, setImagen, selectedTeam, setSelectedTeam, tipo, setTipo, opened, close, handleInsertPlayer, teams}) {
    return (
      <>
